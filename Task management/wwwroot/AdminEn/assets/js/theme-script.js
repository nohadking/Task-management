...
setTimeout(function () {
    $('.main-wrapper').append('<div class="sidebar-settings nav-toggle" id="layoutDiv">' +
        ...
        '<img src="/AdminEn/assets/img/theme/theme-img-01.jpg" alt="">' +
        ...
        '<img src="/AdminEn/assets/img/theme/theme-img-02.jpg" alt="">' +
        ...
        '<a href="../template/index.html"><img src="/AdminEn/assets/img/theme/theme-img-01.jpg" alt=""></a>' +
        ...
        '<div class="d-flex align-items-center">' +
        '<div class="status-toggle d-flex align-items-center me-2">' +
        '<input type="radio" name="direction" id="rtl" class="check direction" value="rtl" checked>' +
        '<label for="rtl" class="checktoggles">' +
        '<a href="../template-rtl/index.html" target="_blank"><img src="/AdminEn/assets/img/theme/theme-img-03.jpg" alt=""></a>' +
        ...
        '<img src="/AdminEn/assets/img/theme/theme-img-07.jpg" alt="">' +
        ...
        '<img src="/AdminEn/assets/img/theme/theme-img-05.jpg" alt="">' +
        ...
        '<img src="/AdminEn/assets/img/theme/theme-img-06.jpg" alt="">' +
        ...
        '<img src="/AdminEn/assets/img/theme/theme-img-04.jpg" alt="">' +
    ...
    loadJS('/AdminEn/assets/js/theme-settings.js', true);
